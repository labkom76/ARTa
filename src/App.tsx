...
import PrintVerifikasi from "./pages/PrintVerifikasi"; // Import the new print page
      ...
      <BrowserRouter>
        <SessionContextProvider>
          <Routes>
            ...
            <Route path="/print-verifikasi" element={<PrintVerifikasi />} /> {/* New route for print page */}
