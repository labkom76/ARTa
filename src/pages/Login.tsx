...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-white dark:bg-slate-950 overflow-hidden font-sans text-slate-900 dark:text-white">
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center px-6 py-12 lg:px-16 order-2 lg:order-2 bg-white dark:bg-slate-950 relative">
        <div className="max-w-md w-full mx-auto">
          ...
          {/* <div className="mt-12 text-center">
            <a href="#" className="text-sm text-slate-400 hover:text-emerald-600 transition-colors">
