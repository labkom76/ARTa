  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
        Kelola daftar kode wilayah yang digunakan dalam aplikasi.
      </p>

      <Card className="shadow-sm rounded-lg">
        <CardHeader>
          <CardTitle className="text-xl font-semibold">Daftar Kode Wilayah</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-gray-600 dark:text-gray-400">
            Konten untuk pengaturan kode wilayah akan ditambahkan di sini.
          </p>
        </CardContent>
      </Card>
    </div>
